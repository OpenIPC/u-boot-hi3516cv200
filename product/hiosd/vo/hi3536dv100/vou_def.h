...
typedef enum tagHAL_DISP_LAYER_E
{
    ...
    HAL_DISP_LAYER_GFX1 = 3 ,    /* NA */ 
    HAL_DISP_LAYER_HC0  = 4,     /* G2 is HC0  --- fb1 */ 
...
#define LAYER_GFX_START  HAL_DISP_LAYER_GFX1  //GFX0
...
typedef enum hiHAL_CSC_MODE_E
{
    ...
    HAL_CSC_MODE_BT601FULL_TO_BT709FULL,
    HAL_CSC_MODE_BT709FULL_TO_BT709FULL,
    HAL_CSC_MODE_BT601LIMIT_TO_BT709FULL,
    HAL_CSC_MODE_BT709LIMIT_TO_BT709FULL,

    HAL_CSC_MODE_BT709FULL_TO_BT601LIMIT,
    HAL_CSC_MODE_BT709FULL_TO_BT601FULL,
