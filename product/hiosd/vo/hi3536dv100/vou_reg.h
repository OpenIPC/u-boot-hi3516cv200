...
/* Define the union U_VORDLATENCY */
typedef union
{
    /* Define the struct bits  */
    struct
    {
        unsigned int rd_max_latency         : 32  ; /* [31..0]  */
    } bits;
...
/* Define the union U_VOWRLATENCY */
typedef union
{
    /* Define the struct bits  */
    struct
    {
        unsigned int wr_max_latency         : 32  ; /* [31..0]  */
    } bits;
...
typedef struct
{
    ...
    U_VORDLATENCY          VORDLATENCY                       ; /* 0x48 */
    U_VOWRLATENCY          VOWRLATENCY                       ; /* 0x4c */
    U_VOINTPROC_TIM        VOINTPROC_TIM                     ; /* 0x50 */
    unsigned int           reserved_1[3]                     ; /* 0x54~0x5c */
    U_VOLOWPOWER_CTRL      VOLOWPOWER_CTRL                   ; /* 0x60 */
    unsigned int           reserved_2[39]                     ; /* 0x64~0xfc */
    ...
    U_VO_DAC_OTP           VO_DAC_OTP                        ; /* 0x124 */
    unsigned int           reserved_4[2]                     ; /* 0x128~0x12c */
