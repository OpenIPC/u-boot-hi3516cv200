...
{
    HI_RegWrite32(0x1, 0xffffffff, IO_ADDRESS(0x120F01A4));
    HI_RegWrite32(0x1, 0xffffffff, IO_ADDRESS(0x120F01A8));
...
{	
    ...
    switch(enLayer)
    {
        ...
        {
            RegAbsAddr = (pReg) + 0 * VHD_REG_LEN;//  V0     
            break;
        }
        case HAL_DISP_LAYER_VHD1:
        {
            RegAbsAddr = (pReg) + 3 * VHD_REG_LEN;//  V3
            break;
        }
        case HAL_DISP_LAYER_VP:
        {
            RegAbsAddr = (pReg) + 1 * VHD_REG_LEN;//  v1
            break;
        }        
        case HAL_DISP_LAYER_VSD0:
        {
            RegAbsAddr = (pReg) + 4 * VHD_REG_LEN;//  v4
            break;
        }
