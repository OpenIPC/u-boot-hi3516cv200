...
typedef struct
{
    ...
    HDMI_HDCP_VERSION_E enHdcpVersion;          /**<Current HDCP version*/
}HDMI_STATUS_S;
...
{
	HI_BOOL                 bEnableHdmi;         /**<force to HDMI or DVI,the value must set before HI_UNF_HDMI_Start or behind HI_UNF_HDMI_Stop*/
    HI_BOOL                 bEnableVideo;        /**<parameter must set HI_TRUE,or the HDMI diver will force to set HI_TRUE*/
    HI_BOOL                 bEnableAudio;        /**<Enable flag of Audio*/

    HDMI_COLORSPACE_E       enOutColorSpace;       /**<HDMI output vedio mode VIDEO_MODE_YCBCR,VIDEO_MODE_YCBCR444, ?VIDEO_MODE_YCBCR422, VIDEO_MODE_RGB444 */
    ...
    HDMI_DEEP_COLOR_E       enDeepColorMode;    /**<Deep Color output mode,defualt: HI_UNF_HDMI_DEEP_COLOR_24BIT */
    HI_BOOL                 bxvYCCMode;          /**<the xvYCC output mode,default:HI_FALSE*/

    HI_BOOL                 bEnableAviInfoFrame; /**<Enable flag of AVI InfoFrame,suggestion:enable */
    HI_BOOL                 bEnableSpdInfoFrame; /**<Enable flag of SPD info frame,suggestion:disable*/
    HI_BOOL                 bEnableMpegInfoFrame;/**<Enable flag of MPEG info frame,suggestion:disable*/
    HI_BOOL                 bEnableAudInfoFrame; /**<Enable flag of Audio InfoFrame,suggestion:enable*/

    HI_U32                  bDebugFlag;          /**<the flag of hdmi dubug,suggestion:disable*/
    HI_BOOL                 bHDCPEnable;         /**<0:HDCP disable mode,1:eable HDCP mode*/
    ...
    HI_BOOL                 bEnableDRMInfoFrame;   /**<Enable flag of DRM InfoFrame,suggestion:enable */
    HDMI_HDCP_MODE_E        enHDCPMode;            /**<HDCP mode:HDMI_HDCP_MODE_NONE, HDMI_HDCP_MODE_1_4, HDMI_HDCP_MODE_2_2*/
}HDMI_APP_ATTR_S;
...
typedef struct
{
    ...
    struct task_struct  *kThreadTimer;    /*timer thread*/
   // struct task_struct  *kThreadCec;      /*CEC thread*/
}HDMI_THREAD_INFO_S;
