/******************************************************************************
  ...
  Copyright (C), 2010-2017, Hisilicon. Co., Ltd.
...
/******************************************************************************/
#define HDMI_CHIP_HI3536D               (0x3536d100)
...
#define HDMI_ADDR_IO_CFG_HOTPLUG        (HDMI_ADDR_BASE_IO_CFG + 0x5c)
#define HDMI_ADDR_IO_CFG_SDA            (HDMI_ADDR_BASE_IO_CFG + 0x60)
#define HDMI_ADDR_IO_CFG_SCL            (HDMI_ADDR_BASE_IO_CFG + 0x64)
#define HDMI_ADDR_IO_CFG_CEC            () /* CEC will not be used on 36D */

#define HDMI_COLOR_BAR_MASK             (0x70000000)
#define HDMI_COLOR_BAR_UPDATE_MASK      (0x00000001)
#define HDMI_COLOR_BAR_BASE             (0x1302c400)
