...
static void hiusb_ohci_enable_clk(void)
{
	...
	/* config clock */
	writel(0x4, MISC_REG_BASE + 0x18);
	mdelay(2);
	/* slew rate */
	writel(0xc4, MISC_REG_BASE + 0x4020);
	udelay(20);
	writel(0xc1, MISC_REG_BASE + 0x4044);
	udelay(20);
	/* disconnect */
	writel(0x1b, MISC_REG_BASE + 0x4028);
	udelay(20);
	writel(0x1c, MISC_REG_BASE + 0x4000);
	udelay(20);
	writel(0x92, MISC_REG_BASE + 0x4014);
	udelay(20);
	writel(0xe, MISC_REG_BASE + 0x4018);
	udelay(20);
