/*
 * Configuation settings for the hi3521d board.
 *
...
#ifndef __CONFIG_HI3521D_H__
#define __CONFIG_HI3521D_H__
...
/*-----------------------------------------------------------------------
 * for timer configuration (udelay)	cpu/hi3521d/hi3521d/timer.c
 * enable timer				board/hi3521d/board.c
 *----------------------------------------------------------------------*/
...
/*-----------------------------------------------------------------------
 * for bootm linux
 * used in file  board/hi3521d/board.c
 -----------------------------------------------------------------------*/
...
/* Except bootrom, hi3521d use XTAL OSC clk 24M */
...
#define CONFIG_PRODUCTNAME		"hi3521d"
